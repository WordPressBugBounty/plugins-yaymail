        ...
        $this->elements    = [
            ...
            ColumnLayout::get_object_data(
                ...
                [
                        ...
                        Column::get_object_data(
                            ...
                            [
                                'children' => [
                                    Text::get_object_data(
                                        [
                                            'rich_text'  => '<h1 style="font-size: 30px; font-weight: 600;">Order #[yaymail_order_id is_plain="true"]<br><br>has been completed</h1>',
                                            'text_color' => '#333439',
                            ...
                            [
                                'children' => [
                                    Image::get_object_data(
                                        [
                                            'align'   => 'left',
                                            'src'     => 'https://images.wpbrandy.com/uploads/yaymail-order-completed-banner-icon.png',
                                            'width'   => 120,
                                            'padding' => [
                                                'top'    => 0,
                                                'right'  => 10,
                    ...
                    'background_image'       => [
                        'url'        => 'https://images.wpbrandy.com/uploads/yaymail-order-completed-banner-bg.png',
                        'position'   => 'custom',
                        'x_position' => 70,
                        'y_position' => 0,
                        'size'       => 'cover',
            ...
            Image::get_object_data(
                [
                    'src'     => 'https://images.wpbrandy.com/uploads/yaymail-order-completed-processing-bar.png',
                    'width'   => 600,
                    'padding' => [
                        'top'    => 0,
                        'right'  => 10,
            ...
            Text::get_object_data(
                [
                    'rich_text'  => '<p>Hi <b>[yaymail_billing_first_name] [yaymail_billing_last_name],</b></p><p>Great news! Your order is about to ship. It should be delivered to you within 7 working days.</p>',
                    'text_color' => '#333439',
                    'padding'    => [
                        'top'    => 15,
                        'right'  => 50,
